...
//    var giftPartnerOutputs = modelMapper.convertGiftPartnerToGiftOutputs(page.getContent());
        ...
        for (GiftPartner giftPartner : page.getContent()) {
            InternalGiftOutput internalGiftOutput = new InternalGiftOutput();
            internalGiftOutput.setId(giftPartner.getId());
            internalGiftOutput.setCategoryId(giftPartner.getCategoryId());
            internalGiftOutput.setName(giftPartner.getName());
            internalGiftOutput.setStartDate(giftPartner.getStartDate());
            internalGiftOutput.setEndDate(giftPartner.getEndDate());
            internalGiftOutput.setGiftCount(giftPartner.getQtyAvail());
            internalGiftOutput.setTotalRemaining(giftPartner.getQtyRemain());
            internalGiftOutput.setDescription(giftPartner.getNotes());
            internalGiftOutput.setLimitGiftPerUser(giftPartner.getLimitGiftPerUser());
            internalGiftOutput.setPrice(giftPartner.getPrice());
            internalGiftOutput.setGuide(giftPartner.getGuide());
            internalGiftOutput.setTermsOfUse(giftPartner.getCondition());
            internalGiftOutput.setImages(giftPartner.getImage());
            internalGiftOutput.setThumbnail(giftPartner.getThumbnail());

            giftPartnerOutputs.add(internalGiftOutput);
        }
...
//      InternalGiftOutput giftOutput = super.modelMapper.convertPartnerGiftToGiftOutput(gift);
        InternalGiftOutput giftOutput = this.convertPartnerGiftToGiftOutput(gift);
    ...
    public static InternalGiftOutput convertPartnerGiftToGiftOutput(GiftPartner gift) {
        InternalGiftOutput giftOutput = new InternalGiftOutput();
        giftOutput.setId(gift.getId());
        giftOutput.setCategoryId(gift.getCategoryId());
        giftOutput.setName(gift.getName());
        giftOutput.setStartDate(gift.getStartDate());
        giftOutput.setEndDate(gift.getEndDate());
        giftOutput.setGiftCount(gift.getQtyAvail());
        giftOutput.setTotalRemaining(gift.getQtyRemain());
        giftOutput.setDescription(gift.getNotes());
        giftOutput.setLimitGiftPerUser(gift.getLimitGiftPerUser());
        giftOutput.setPrice(gift.getPrice());
        giftOutput.setGuide(gift.getGuide());
        giftOutput.setTermsOfUse(gift.getCondition());
        giftOutput.setImages(gift.getImage());
        giftOutput.setThumbnail(gift.getThumbnail());
